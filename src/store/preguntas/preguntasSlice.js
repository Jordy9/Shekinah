...
export const { getPreguntas, mostrarIdPregunta, getPreguntasTema, getPreguntasGame, paginacion, preguntaActiva, crearPreguntaActiva, actualizarPreguntaActiva, eliminarPreguntaActiva } = preguntasSlice.actions;